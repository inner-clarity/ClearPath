      ...
      '/en/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Life stages (cont.)', link: '/en/mitos-life-stages-continuacion' },
            { text: 'Cultures', link: '/en/mitos-culturas' },
            { text: 'Cultures (cont.)', link: '/en/mitos-cultures-continuacion' },
            { text: 'Social Classes', link: '/en/mitos-clases-sociales' },
            { text: 'Social Classes (cont.)', link: '/en/mitos-social-classes-continuacion' },
            { text: 'Work Impact', link: '/en/mitos-laboral' },
            { text: 'Work Impact (cont.)', link: '/en/mitos-workplace-continuacion' },
            ...
            { text: 'Love (cont.)', link: '/en/mitos-love-continuacion' },
            { text: 'Marriage', link: '/en/mitos-relaciones' },
            { text: 'Family', link: '/en/mitos-familia' },
            { text: 'Family (cont.)', link: '/en/mitos-family-continuacion' },
            { text: 'Friendship', link: '/en/mitos-amistad' },
            { text: 'Friendship (cont.)', link: '/en/mitos-friendship-continuacion' },
            { text: 'Education', link: '/en/mitos-educacion' },
            { text: 'Education (cont.)', link: '/en/mitos-education-continuacion' },
            { text: 'Evolution', link: '/en/mitos-evolucion' },
            { text: 'Evolution (cont.)', link: '/en/mitos-evolution-continuacion' },
            { text: 'Fears', link: '/en/mitos-miedos' },
            { text: 'Fears (cont.)', link: '/en/mitos-fears-continuacion' }
          ]
        },
        {
      ...
      '/pt/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Adolescência e juventude', link: '/pt/mitos-juventude' },
            { text: 'Batismo e crianças', link: '/pt/mitos-batismo' },
            { text: 'Adultos idosos', link: '/pt/mitos-adultos-mayores' },
            { text: 'Etapas da vida', link: '/pt/mitos-etapas-da-vida' },
            { text: 'Etapas da vida (cont.)', link: '/pt/mitos-etapas-da-vida-continuacao' },
            { text: 'Culturas', link: '/pt/mitos-culturas' },
            { text: 'Culturas (cont.)', link: '/pt/mitos-culturas-continuacao' },
            { text: 'Classes Sociais', link: '/pt/mitos-classes-sociais' },
            { text: 'Classes Sociais (cont.)', link: '/pt/mitos-classes-sociais-continuacao' },
            { text: 'Impacto Laboral', link: '/pt/mitos-laboral' },
            { text: 'Impacto Laboral (cont.)', link: '/pt/mitos-laboral-continuacao' },
            { text: 'Criação de filhos', link: '/pt/mitos-criacao' },
            { text: 'Missão e serviço', link: '/pt/mitos-missao' },
            { text: 'Luto e perda', link: '/pt/mitos-luto' },
            { text: 'Oração e estudo', link: '/pt/mitos-oracao' },
            { text: 'Liderança', link: '/pt/mitos-lideranca' },
            { text: 'Amor', link: '/pt/mitos-amor' },
            { text: 'Amor (cont.)', link: '/pt/mitos-amor-continuacao' },
            { text: 'Casamento', link: '/pt/mitos-relacoes' },
            { text: 'Família', link: '/pt/mitos-familia' },
            { text: 'Família (cont.)', link: '/pt/mitos-familia-continuacao' },
            { text: 'Amizade', link: '/pt/mitos-amistade' },
            { text: 'Amizade (cont.)', link: '/pt/mitos-amistade-continuacao' },
            { text: 'Educação', link: '/pt/mitos-educacao' },
            { text: 'Educação (cont.)', link: '/pt/mitos-educacao-continuacao' },
            { text: 'Evolução', link: '/pt/mitos-evolucao' },
            { text: 'Evolução (cont.)', link: '/pt/mitos-evolucao-continuacao' },
            { text: 'Medos', link: '/pt/mitos-medos' },
            { text: 'Medos (cont.)', link: '/pt/mitos-medos-continuacao' }
          ]
        },
        {
        ...
        },
        {
          text: 'Mitos Gerais',
          items: [
            { text: 'Mitos 1–10', link: '/pt/mitos-gerais-1' },
